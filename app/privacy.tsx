    ...
    <View style={[styles.container, { backgroundColor: isDark ? '#121212' : '#F5F5F5' }]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <Text style={[styles.heading, { color: isDark ? '#FFFFFF' : '#000000' }]}>
          Privacy Policy for Introvert Chat
        </Text>
        
        <Text style={[styles.date, { color: isDark ? '#BBBBBB' : '#666666' }]}>
          Last updated: June 1, 2025
        </Text>
        
        <Text style={[styles.paragraph, { color: isDark ? '#FFFFFF' : '#000000' }]}>
        ...
        <Text style={[styles.sectionHeading, { color: isDark ? '#FFFFFF' : '#000000' }]}>
          Interpretation and Definitions
        </Text>
        
        <Text style={[styles.subheading, { color: isDark ? '#FFFFFF' : '#000000' }]}>
          Interpretation
        </Text>
        ...
        <View style={styles.bulletList}>
          <Text style={[styles.bulletItem, { color: isDark ? '#FFFFFF' : '#000000' }]}>
          ...
          <Text style={[styles.bulletItem, { color: isDark ? '#FFFFFF' : '#000000' }]}>
            • <Text style={styles.bold}>Application</Text> refers to Introvert Chat, the software program provided by the Company.
          </Text>
          <Text style={[styles.bulletItem, { color: isDark ? '#FFFFFF' : '#000000' }]}>
            • <Text style={styles.bold}>Company</Text> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Introvert Chat.
          </Text>
          <Text style={[styles.bulletItem, { color: isDark ? '#FFFFFF' : '#000000' }]}>
        ...
        <Text style={[styles.tertiaryHeading, { color: isDark ? '#FFFFFF' : '#000000' }]}>
          Personal Data
        </Text>
        ...
        <View style={styles.bulletList}>
          <Text style={[styles.bulletItem, { color: isDark ? '#FFFFFF' : '#000000' }]}>
            • By email: keith.kurak[at]gmail.com
          </Text>
        </View>
      </ScrollView>
    </View>
